...
* > A GitHub account. If you don't have one, sign up for [free](https://github.com/join). 
    * Fork your own copy of this repo to your account. 
    * Run a workflow to build the solution and create the release binaries. 
...
1. Update the following fields in the template:
    ...
    19. **gitRepoUrl**: This is a URL of **your** forked repository.
    20. **Release Tag [Optional]**: By default the latest release will be used.  
...
2. Update the "Sender UPN List", which is a semicolon-delimited list of users (Authors) who will be allowed to send messages using the Company Communicator.
...
3. If you wish to change the app name, description, and icon from the defaults, modify the corresponding template parameters.

4. Agree to the Azure terms and conditions by clicking on the check box "I agree to the terms and conditions stated above" located at the bottom of the page.

5. Click on "Purchase" to start the deployment.

6. Wait for the deployment to finish. You can check the progress of the deployment from the "Notifications" pane of the Azure Portal. It may take **up to an hour** for the deployment to finish.
...
7. Once the deployment is successfully completed, go to the deployment's "Outputs" tab, and note down the follwing values. We will need them later.
